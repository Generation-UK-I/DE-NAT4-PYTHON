...
2. Store a message in a variable, and print that message, then, within your code, change the value of your variable to a new message, and print the new message.
